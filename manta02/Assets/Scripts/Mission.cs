...
public class CallMission : Mission
{

    DbChecker db;
    // 게임 시작과 동시에 시작되는 미션으로, 119에 신고하는 미션이다.
    public CallMission()
    {
        db = GameObject.Find("GameRoot").GetComponent<DbChecker>();
        missionName = "신고미션";
        score = 20;
        missionDialog.Add("\"불이야!\" 라고 크게 외쳐서 상황을 전파하세요!");
        missionDialog.Add("좀더 크게!");
    ...
    public override void MissionEvent()
    {
        ...
        {
            db.gameObject.GetComponent<AudioSource>().enabled = false;
        }
    ...
    public class StartMission : Mission
    {
        ...
        public StartMission()
        {
            missionName = "스타트미션";
            score = 50;
            missionDialog.Add("주변을 둘러보면서 화재원을 찾아보세요!");
            missionDialog.Add("");
